...
select (select count(*) from public.perumahan where id in (
  '98cb769b-61da-481b-8e39-219a3e0fa3f3','6b1d79fc-2018-4ad8-9171-257e583cf9bd','00a363e7-4991-4d59-89f8-ea26aac3791f','46f96496-3c3a-4636-902d-b34e82ae50d6')) as sisa_perumahan,
       (select count(*) from auth.users where email like 'rk-demo-%@example.com' or email like 'rk-sec-%@example.com' or email like 'rk-fin-%@example.com' or email like 'rk-lang-%@example.com') as sisa_akun_tes,
